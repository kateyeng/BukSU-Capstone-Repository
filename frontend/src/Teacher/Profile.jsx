...
export default function TeacherProfile() {
        ...
        try {
            ...
            if (nameChanged) {
                ...
                try {
                    ...
                    updatedUser = { ...(updatedUser || {}), name: trimmedName };
                }
            ...
            // notify sidebar so it updates
            window.dispatchEvent(
                new CustomEvent("profile-updated", {
                    detail: { user: { ...(me || {}), name: trimmedName } },
                })
            );
    ...
    return (
        <div className="teacher-layout">
            ...
            {/* we override teacher-main styling a bit with inline styles */}
            <main
