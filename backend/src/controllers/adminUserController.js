...
export async function getAdminUsers(req, res) {
  try {
    ...
    const result = users.map((u) => ({
      ...
      // include lock info if you want the "Editing..." UI to work correctly
      editLock:
        u.editLock?.expiresAt && new Date(u.editLock.expiresAt) > new Date()
          ? {
              lockedBy: String(u.editLock.lockedBy),
